...
import profileImage from '../assets/Screenshot from 2024-05-15 13-41-15.png'
    ...
    <div className="flex flex-col md:flex-row items-center bg-gray-900 text-white min-h-screen p-8 md:p-20">
      <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
        ...
        <p className="mt-4 text-gray-300">
          Passionate software engineer skilled in HTML5, CSS, JavaScript, React, Python, Flask, Figma designing,
      ...
      <div className="md:w-1/2 flex justify-center md:justify-end">
        <img src={profileImage} alt="Profile" className="rounded-full w-48 h-48 md:w-64 md:h-64 object-cover shadow-lg border-4 border-teal-400" />
      </div>
    </div>
  );
}
